...
class TestComputeAnnualMean:
    ...
    def test_mean_with_valid_data(self, sample_temperatures: list[float | None]) -> None:
...
class TestAnalyticsServiceMonthly:
    ...
    def test_monthly_data_single_station(
        self, valid_station_ids: list[str]
    ) -> None:
    ...
    def test_monthly_data_point_structure(
        self, valid_station_ids: list[str]
    ) -> None:
        ...
        assert data_point.temperature is None or isinstance(data_point.temperature, float)


class TestAnalyticsServiceAnnual:
    """Tests for AnalyticsService.get_annual_data method."""
    
    def test_annual_data_structure(
        self, valid_station_ids: list[str]
    ) -> None:
    ...
    def test_annual_data_sigma_bounds(
        self, valid_station_ids: list[str]
    ) -> None:
        """Should compute correct ±1σ bounds."""
        result = analytics_service.get_annual_data(
    ...
    def test_annual_data_reduces_points(
        self, valid_station_ids: list[str]
    ) -> None:
...
class TestAnalyticsServiceAnalytics:
    ...
    def test_analytics_min_max_consistency(
        self, valid_station_ids: list[str]
    ) -> None:
    ...
    def test_analytics_data_coverage(
        self, valid_station_ids: list[str]
    ) -> None:
