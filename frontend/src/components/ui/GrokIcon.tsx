/**
 * Official Grok (xAI) icon component
 * Source: https://logos-download.com/brands/grok
 */
...
export function GrokIcon({ size = 24, color = 'currentColor', className }: GrokIconProps) {
  return (
    <svg
      width={size}
      height={size}
